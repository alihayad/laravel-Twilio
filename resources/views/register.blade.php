                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('user.register') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone_number" type="text" class="mt-2 form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') }}" required autocomplete="phone_number">
